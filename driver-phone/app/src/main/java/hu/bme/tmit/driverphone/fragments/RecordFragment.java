...
public class RecordFragment extends Fragment
    ...
    private static long recordedVideoId;
    ...
    private MetaCollectorThread metaCollectorThread;
    /**
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        recordVideo = view.findViewById(R.id.video);
    ...
    private void setUpMediaRecorder() throws IOException {
        ...
        int rotation = activity.getWindowManager().getDefaultDisplay().getRotation();
        Log.d(TAG, "setUpMediaRecorder: orientation = " + rotation);
    ...
    private String getMetaFilePath(Context context) {
        final File dir = context.getExternalFilesDir(null);
        return (dir == null ? "" : (dir.getAbsolutePath() + "/"))
                + ((HomeActivity) getActivity()).getUserName()
                + "_"
    ...
    private void startRecordingVideo() {
        ...
        try {
            ...
            recordedVideoId = System.currentTimeMillis();
            metaCollectorThread = new MetaCollectorThread(getContext(), getMetaFilePath(getContext()));
            new Thread(metaCollectorThread).start();
            ...
            mCameraDevice.createCaptureSession(surfaces, new CameraCaptureSession.StateCallback() {
                ...
                public void onConfigured(@NonNull CameraCaptureSession cameraCaptureSession) {
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            // UI
                            recordVideo.setTextColor(Color.RED);
                            recordVideo.setText(R.string.stop);
    ...
    private void stopRecordingVideo() {
        //meta collection stop
        metaCollectorThread.setRunning(false);
        // UI
        mIsRecordingVideo = false;
        recordVideo.setText(R.string.record);
        recordVideo.setTextColor(Color.WHITE);
        // Stop recording
        mMediaRecorder.stop();
